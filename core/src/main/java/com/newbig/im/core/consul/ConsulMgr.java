...
//        List<GetValue> list = JSON.parseArray(rawResponse.getContent(), GetValue.class);
...
//        List<HealthService> slist = JSON.parseArray(rawResponse.getContent(), HealthService.class);
...
//        com.ecwid.consul.v1.agent.model.Service aservice = JSON.parseObject(rawResponse.getContent(),
//                com.ecwid.consul.v1.agent.model.Service.class);
